...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render translated MinerU content_list_v2 experiment JSONs into a PDF.")
    parser.add_argument(
        "--translations-dir",
        type=str,
    ...
    parser.add_argument(
        "--layout-json",
        type=str,
        default="output/mineru/test9/unpacked/layout.json",
        help="Optional MinerU layout.json for bbox/line alignment before rendering.",
    )
...
def main() -> None:
    ...
    if layout_json.exists():
        ...
        print(f"layout json not found, render without alignment: {layout_json}")
