...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Adapt MinerU content_list_v2.json into a normalized intermediate JSON.")
    parser.add_argument(
        "--input",
        type=str,
        default="output/mineru/test9/unpacked/content_list_v2.json",
    ...
    parser.add_argument(
        ...
        help="Path to adapted intermediate JSON output",
    )
